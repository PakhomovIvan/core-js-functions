 ...
 *   partialUsingArguments(fn, 'a','b','c','d')() => 'abcd'
 */
function partialUsingArguments(e, ...arg) {
  return (...resArg) => e(...arg, ...resArg);
}
 ...
 *   getId10() => 11
 */
function getIdGeneratorFunction(startIndex) {
  let indexHelp = startIndex - 1;
  return () => {
    indexHelp += 1;
    return indexHelp;
  };
